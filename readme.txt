...
└── Vide.java
    ...
    On peut découper un segment en plusieurs champs:
      - toutes les classes utilisent l'interface IChamp
      - certains champ auront une fonction permettant d'obtenir le segment suivant (Port.java et les classes dans trameSuiv/)
      ...
      - Data.java est inclassable car utilisable par beaucoup de segment
...
└── Reserved.java
   ...
   Comme dit en 4), les flags permettent de faire un traitement bit par bit:
     ...
     - seul les segments TCP, IP et DNS ont un champs Flags
     - le seul flags en commun est Reserved dont les bits doivent être à zéro
     - toutes les autres classes sont spécifiques à un segment et ont été séparés par dossier
